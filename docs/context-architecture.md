...
| All | `skill-body:design-build` | `bundled-context/skills/design-build/SKILL.md` | 16,423 | 4,106 | on-demand |
...
| All | `skill-body:qa-report` | `bundled-context/skills/qa-report/SKILL.md` | 4,183 | 1,046 | on-demand |
