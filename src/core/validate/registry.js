...
const RULE_REGISTRY = {
    ...
    duplicateCase: { severity: "error", category: "workflow", gate: "per-file", evidence: "Owner-approved correctness gate documented beside the workflowJs.js rule." },
    ...
    debugTagShipped: { severity: "error", category: "markup", gate: "per-file", evidence: "Vendored c-tag contract and live save behavior documented in markup.js." },
    designClassRequired: { severity: "error", category: "markup", gate: "per-file", evidence: "Owner-approved policy gate (Sam, 2026-07-18): a declared design system must own core controls consistently." },
