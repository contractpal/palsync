...
const { VIEWPORTS, sanitizeUrl, sanitizeResourceUrl, waitForRenderablePage,
        loadChromium, releaseBrowser } = require("./browser");
...
module.exports = {
    runScreenshot, detectRenderError, downscaleToJpeg, inspectStyleStatus,
    inspectDesignQuality, isScalarParamValue, safeObservedState,
