...
function syncDetails(palName, { cli = false, skillsDir = ".claude/skills" } = {}) {
    ...
    return [
        ...
        "6. For a PUBLIC WEB page, run **" + T.seo + "** after pushing when its markup changed — it checks",
        "   title/description, ABSOLUTE og: URLs, one H1, JSON-LD, img alt text. Do not declare a public web",
        "   page done while it reports errors. (Read the palbuilder-seo skill first when it\'s present.)",
        "",
