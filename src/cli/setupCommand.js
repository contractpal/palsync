...
const USAGE = [
    ...
    "  --agent claude|codex|pi|opencode|gemini|cursor|copilot  which agent's context/MCP to write (default: claude; pi installs the native lazy-loading extension globally)",
