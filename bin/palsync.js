...
const SUBCOMMANDS = ["push", "pull", "merge", "status", "test", "preview", "open", "fetch", "screenshot", "validate", "doctor", "sync-datasets", "seo-audit", "exercise", "cost", "ctx", "review", "completion", "hook", "hooks", "regression", "spec-lint", "task", "checkpoint"];
